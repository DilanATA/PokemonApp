package com.dilanata.pokemonapp.service
...
class Window(context: Context) {
    ...
    init {
        ...
        mView = layoutInflater.inflate(R.layout.popup_pokemon_window, null)
        // set onClickListener on the remove button, which removes
        // the view from the window
        mView.findViewById<Button>(R.id.window_close).setOnClickListener(object : View.OnClickListener {
